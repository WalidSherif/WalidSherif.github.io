...
tools:
  ...
  - Harmonic Analysis
highlights:
  - Analyzed a single-phase inverter with a 20 V DC source and an R–L load at 50 Hz.
  - Implemented and compared square-wave, quasi-square-wave, selective harmonic elimination, bipolar PWM, and unipolar PWM strategies.
  - Used numerical methods to determine switching angles and evaluate harmonic content and waveform quality.
