...
tools:
  ...
  - FEA
highlights:
  - Developed an integrated CAE workflow covering aerodynamic analysis, one-way fluid-structure interaction, and resonance assessment.
  - Performed 3D steady CFD on a NACA 2424 blade using a rotating-domain setup and the k-ω SST turbulence model.
  - Mapped aerodynamic pressure loads into the structural model to evaluate deformation and stress response.
...
result: Built an integrated CFD, one-way FSI, and modal-analysis workflow for a NACA 2424 wind-turbine blade.
